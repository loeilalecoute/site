...
<li>
	<a
		href=""
		class="item origin-left text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold inline-block hover:text-yellow hover:opacity-100 focus-visible:text-yellow focus-visible:opacity-100"
